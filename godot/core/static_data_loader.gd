...
var files_to_patch: Array[String] = ["units", "items", "skills_ability", "skills_magic", "skills_passive", "equipment", "limitbursts", "materia", "equipment-icons", "summons", "summons_boards", "summons_exp_patterns", "summons_stat_patterns", "unit_exp_patterns", "rank_exp"]
