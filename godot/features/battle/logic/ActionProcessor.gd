...
func _apply_basic_attack(parsed_effect: Dictionary, caster: Dictionary, targets: Array) -> Array[Dictionary]:
	return _process_standard_damage(parsed_effect, caster, targets)

func _process_standard_damage(effect: Dictionary, caster: Dictionary, targets: Array) -> Array[Dictionary]:
