...
@onready var energy_label: Label = $PlateButton/Overlay/StatsColumn/EnergyLabel
@onready var battles_label: Label = $PlateButton/Overlay/StatsColumn/BattlesLabel
@onready var difficulty_label: Label = $PlateButton/Overlay/DifficultyLabel
...
func configure(
	...
	if difficulty_text != "":
		difficulty_label.text = "Difficulty %s" % difficulty_text
