...
# Mirrors town_parser.py: town data lives under the Godot project, one level
# up from tools/. (This previously resolved to tools/assets/town_data, so every
# lookup through parse.py / exploration_parser.py failed with "folder not
# found".)
REPO_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
TOWN_DATA_ROOT = os.path.join(REPO_ROOT, "godot", "assets", "town_data")
